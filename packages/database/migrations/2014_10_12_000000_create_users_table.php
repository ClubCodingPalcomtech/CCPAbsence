...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('users', function (Blueprint $table) {
            ...
            $table->char('googleid', 30)->unique()->nullable();
            $table->char('facebookid', 30)->unique()->nullable();
            $table->timestamps();
            $table->boolean('status')->default(true);
        });
        //DB::statement('ALTER TABLE users CHANGE npmid npmid INT(10) UNSIGNED ZEROFILL NOT NULL');
    }
