...
<body class="font-sans antialiased">
    <div id="ccp-app">
        ...
        <div>
            <section class="h-100 py-5 postercard-form">
                <div class="container">
                    <div class="row d-flex justify-content-center align-items-center">
                        <div class="col-xl-10">
                            <b-card class="card rounded-3 border shadow-lg text-black" no-body>
                                <b-row class="g-0" no-gutters>
                                    <b-col md="6">
                                        @yield('content')
                                    </b-col>
                                    <b-col md="6" class="d-flex align-items-center postercard-overlay" :style="{ 'background-image': 'url(' + posterBanner + ')' }">
                                        @yield('postercard')
                                    </b-col>
                                </b-row>
                            </b-card>
        ...
        const app = new window.Vue({
            ...
            data: function() {
                return Object.assign({
                    ...
                    'urlOpenIDGoogle': '{!! $urlOpenIDGoogle !!}',
                    'urlOpenIDFacebook': '{!! $urlOpenIDFacebook !!}'
                }, @yield('vuedata', '{}'));
            },
